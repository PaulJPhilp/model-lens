...
describe('GET /api/filters/[id]', () => {
  ...
  it('should get filter by id for owner', async () => {
    ...
    const response = await GET(request, { params: Promise.resolve({ id: privateFilterId }) });
  ...
  it('should allow anyone to get public filter', async () => {
    ...
    const response = await GET(request, { params: Promise.resolve({ id: publicFilterId }) });
    const data = await response.json();
  ...
  it('should allow team member to get team filter', async () => {
    ...
    const response = await GET(request, { params: Promise.resolve({ id: teamFilterId }) });
    const data = await response.json();
...
describe('PUT /api/filters/[id]', () => {
  ...
  it('should update filter name and description', async () => {
    ...
    const response = await PUT(request, { params: Promise.resolve({ id: filterId }) });
    const data = await response.json();
...
describe('DELETE /api/filters/[id]', () => {
  ...
  it('should delete filter when called by owner', async () => {
    ...
    const response = await DELETE(request, { params: Promise.resolve({ id: filterId }) });
    const data = await response.json();
