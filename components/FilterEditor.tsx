...
export function FilterEditor({ filter, onSave, onCancel }: FilterEditorProps) {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      {/* Description */}
      <div>
        <label htmlFor="filter-description" className="block text-sm font-medium mb-2">
          Description
        </label>
        <Textarea
      ...
      {/* Visibility */}
      <div>
        <label htmlFor="filter-visibility" className="block text-sm font-medium mb-2">
          Visibility
        </label>
      ...
      {visibility === 'team' && (
        <div>
          <label htmlFor="filter-teamId" className="block text-sm font-medium mb-2">
            Team ID *
          </label>
          <Input
            id="filter-teamId"
                ...
                <div>
                  ...
                  <Select
                    ...
                    onValueChange={(operator) =>
                      updateRule(index, { operator: operator as RuleClause['operator'] })
                    }
                  >
                    <SelectTrigger>
                      <SelectValue />
                ...
                <div>
                  ...
                  >
                    ...
                    <SelectContent>
                      ...
                      <SelectItem value="soft">Soft (weighted score)</SelectItem>
                    </SelectContent>
                  </Select>
                </div>
      ...
      <div className="flex gap-3">
        <Button type="submit" disabled={loading} className="flex-1">
          {loading ? 'Saving...' : isEditMode ? 'Update Filter' : 'Create Filter'}
        </Button>
        {onCancel && (
