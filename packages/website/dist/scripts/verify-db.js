...
import { closeDb, db, testConnection } from "../db/index.js";
import { savedFilters } from "../db/schema.js";
import { evaluateFilterAgainstModel, formatEvaluationResult, } from "../lib/filters.js";
/**
...
async function main() {
    ...
    try {
        ...
        console.error("   psql $DATABASE_URL -f db/migrations/" +
