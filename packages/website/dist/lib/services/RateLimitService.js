...
export const RateLimitServiceLive = Layer.succeed(RateLimitService, {
    checkRateLimit: (identifier, limit, window) => Effect.gen(function* () {
...
export const checkApiRateLimit = (identifier) => Effect.promise(() => apiRateLimiter.limit(identifier));
export const checkAdminRateLimit = (identifier) => Effect.promise(() => adminRateLimiter.limit(identifier));
export const checkModelFetchRateLimit = (identifier) => Effect.promise(() => modelFetchRateLimiter.limit(identifier));
