	...
	validateFilters: (filters: Partial<Filters>) =>
		Effect.gen(function* () {
			...
			const validated: Filters = {
				providers: filters.providers ?? [],
				inputCostRange: filters.inputCostRange ?? [0, 1000],
				outputCostRange: filters.outputCostRange ?? [0, 1000],
				cacheReadCostRange: filters.cacheReadCostRange ?? [0, 1000],
				cacheWriteCostRange: filters.cacheWriteCostRange ?? [0, 1000],
				modalities: filters.modalities ?? [],
				capabilities: filters.capabilities ?? [],
				years: filters.years ?? [],
				openWeights: filters.openWeights ?? null,
